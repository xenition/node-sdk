    ...
    jobs: {
        '/jobs/{id}': {
            get: {
                ...
                description: 'Visible only when the job payload names the caller (default field `userId`). ' +
    ...
    billing: {
        ...
        '/billing/verify': {
            post: {
                ...
                description: 'apple: { platform: "apple", transactionId }. ' +
        ...
        '/billing/trial': {
            post: {
                ...
                description: 'Idempotent: a second call returns the current entitlement rather than an error. ' +
        ...
        '/billing/webhooks/apple': {
            post: {
                ...
                description: 'Unauthenticated by necessity — Apple cannot present a user token. Safe because the ' +
