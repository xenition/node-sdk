...
class AiClient {
    ...
    async generateText(prompt, options = {}) {
        const result = await this.http.post(constants_1.API_ENDPOINTS.AI.TEXT, {
            prompt,
            ...options,
        });
    ...
    async chat(messages, options = {}) {
        const result = await this.http.post(constants_1.API_ENDPOINTS.AI.CHAT, {
            messages,
            ...options,
        });
