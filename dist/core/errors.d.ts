 ...
 */
export declare const XENITION_ERROR_CODES: readonly ["NETWORK_ERROR", "TIMEOUT", "SERVER_ERROR", "RATE_LIMITED", "CANCELLED", "AUTH_INVALID_CREDENTIALS", "AUTH_INVALID_TOKEN", "AUTH_EXPIRED_TOKEN", "AUTH_EMAIL_EXISTS", "AUTH_WEAK_PASSWORD", "AUTH_FORBIDDEN", "AUTH_PROVIDER_NOT_CONFIGURED", "NOT_FOUND", "VALIDATION_ERROR", "CONFLICT", "QUERY_FAILED", "QUERY_TABLE_NOT_FOUND", "PAYMENT_FAILED", "ENTITLEMENT_REQUIRED", "IAP_INVALID_RECEIPT", "IAP_ALREADY_OWNED", "QUOTA_EXCEEDED", "STORAGE_TOO_LARGE", "STORAGE_FAILED", "JOB_FAILED", "AI_UNPARSEABLE", "NOT_IMPLEMENTED", "UNKNOWN"];
